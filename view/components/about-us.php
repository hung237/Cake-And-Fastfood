        ...
        <div class="container ">
            ...
            <div class="introduce-items ">
                <div class="introduce-items-img ">
                    <img src="./view/assets/image/aboutcake3.png" alt="" width="500px">
                </div>
            ...
            <div class="introduce-items ">
                ...
                <div class="introduce-items-img ">
                    <img src="./view/assets/image/aboutcake2.png" alt="" width="500px">
                </div>
            </div>
            <div class="introduce-items ">
                <div class="introduce-items-img ">
                    <img src="./view/assets/image/aboutcake1.png" alt="" width="400px">
                </div>
                <div class="introduce-items-des text-right">
            ...
            <div class="text-center mono-img">
                ...
                <div class="mono-items">
                    <div class="mono-items-img">
                        <img src="./view/assets/image/mono3.png" alt="">
                    </div>
                ...
                <div class="mono-items">
                    <div class="mono-items-img">
                        <img src="./view/assets/image/mono1.png" alt="">
                    </div>
                    <div class="mono-items-des">
                        <h2>MILK</h2>
                ...
                <div class="mono-items">
                    <div class="mono-items-img">
                        <img src="./view/assets/image/mono2.png" alt="">
                    </div>
                    <div class="mono-items-des">
                        <h2>BUTTER</h2>
                ...
                <div class="mono-items">
                    <div class="mono-items-img">
                        <img src="./view/assets/image/mono4.png" alt="">
                    </div>
                    <div class="mono-items-des">
                        <h2>CHOCOLATE</h2>
            ...
            <div class="box-team margin-top-40px">
                <div class="team-items line-height">
                    <div class="team-items-img">
                        <img src="./view/assets/image/avt-bao.png" alt="" width="200px">
                    </div>
                ...
                <div class="team-items line-height">
                    <div class="team-items-img">
                        <img src="./view/assets/image/avt-duong.png" alt="" width="200px">
                    </div>
                    <div class="team-items-des text-center">
                        <h3>Lê Trần
                            Bạch Dương </h3>
                ...
                <div class="team-items line-height">
                    <div class="team-items-img">
                        <img src="./view/assets/image/avt-tai.png" alt="" width="200px">
                    </div>
                    <div class="team-items-des text-center">
                        <h3>Hồ Hữu Tài</h3>
                ...
                <div class="team-items line-height">
                    <div class="team-items-img">
                        <img src="./view/assets/image/avt-hung.png" alt="" width="200px">
                    </div>
                    <div class="team-items-des text-center">
                        <h3>Bùi Phi Hùng</h3>
                ...
                <div class="team-items line-height">
                    <div class="team-items-img">
                        <img src="./view/assets/image/avt-tra.png" alt="" width="200px">
                    </div>
                    <div class="team-items-des text-center">
